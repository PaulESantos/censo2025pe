...
This outlines how to propose a change to censo2025pe. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("PaulESantos/censo2025pe", fork = TRUE)`.
...
Please note that the censo2025pe project is released with a [Contributor
Code of
Conduct](https://paulesantos.github.io/censo2025pe/CODE_OF_CONDUCT.md).
